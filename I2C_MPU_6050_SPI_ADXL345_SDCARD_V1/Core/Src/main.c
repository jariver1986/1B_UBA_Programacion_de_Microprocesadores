...
// ============================================
//   CONEXIONES STM32F446RE ↔ LCD I2C (PCF8574)
// ============================================
//
// LCD I2C     ↔   STM32F446RE
//
// VCC         ↔   5V               // Alimentación (verifica compatibilidad)
// GND         ↔   GND              // Tierra común
// SDA         ↔   PB7              // I2C1 SDA (requiere pull-up si el módulo no lo tiene)
// SCL         ↔   PB6              // I2C1 SCL (requiere pull-up si el módulo no lo tiene)
...
void MPU6050_Read_All(void)
{
  ...
  // HAL_I2C_Mem_Read(
  //   &hi2c1,                   // I2C que estás usando (I2C1)
  //   MPU6050_ADDR,            // Dirección del sensor (0x68 << 1 = 0xD0)
  //   MPU6050_ACCEL_XOUT_H,    // Registro inicial: 0x3B (donde comienza AccX)
  //   I2C_MEMADD_SIZE_8BIT,    // Tamaño de dirección del registro (8 bits)
  //   raw_data,                // Buffer donde se guardan los 14 bytes leídos
